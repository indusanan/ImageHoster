...
public class ImageController {
    ...
    //This method fetches the image with the corresponding id from the dataase and adds it to the model with the key as 'image'
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        if ((user.getProfile().getFullName().equals(lUser.getProfile().getFullName()))) {
            return "images/edit";
